    ...
    <div class="mt-12 flex flex-col lg:flex-row gap-8 items-center">
      <div class="w-full lg:w-1/2">
        <div class="relative overflow-hidden rounded-3xl border border-pink-200 bg-white">
          ...
          <img src="https://i.pinimg.com/736x/a7/e5/ee/a7e5ee42bc66f3b4196aeb6348f8738e.jpg" alt="<?php esc_attr_e( 'Soft evening self-care moment', 'lumina-skin' ); ?>" class="sm:h-72 lg:h-80 w-full h-64 object-cover">
        </div>
      </div>
      <div class="w-full lg:w-1/2">
