...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
	...
	<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
		...
		$products = array(
			...
			array(
				'img'     => 'https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTtFei_M7IMYg9QZUvp8Etw2506wG5-fJiAU7uUNRsiNsELW5vchq7xhqj7mSYXR5EF-VhIFOsrccUze6qxwqc8hE54G8O31wRbMYLpsm-hSkAFil4QCSiB',
				'badge'   => 'BEST FOR ACNE',
			...
			array(
				'img'     => 'https://nihonmart.id/pub/media/catalog/product/cache/8a3fa81d90974d9a7299f2eff309979f/y/u/yuja_dark_spot_moisturizer-min.png',
				'badge'   => 'SPOT CARE',
			...
			array(
				'img'     => 'https://images.soco.id/b083a312-7891-4003-9160-49676bf20326-image-1-1764666103960',
				'badge'   => 'BESTSELLER',
	...
	<div class="mb-6 flex items-center justify-center gap-4">
		...
		<div class="flex flex-col items-start">
			<div class="flex items-center">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 fill-[#F472B6] text-[#F472B6]">
				...
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 fill-[#F472B6]/50 text-[#F472B6]">
